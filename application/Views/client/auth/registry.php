                        ...
                        <h1>ĐĂNG KÝ TÀI KHOẢN</h1>
                            <div class="row mx-0">
                                ...
                                <div class="col-12 mb-3 p-0">
                                    ...
                                    <input value="<?php echo isset($old_inputs) && isset($old_inputs['name']) ? $old_inputs['name'] : "" ?>" type="text" class="form-control" placeholder="Nhập họ tên" name="name">
                                </div>
                                ...
                                <div class="col-12 mb-3 p-0">
                                   ...
                                   <div class="position-relative">
                                        ...
                                        <div style="<?php echo isMobileDevice() ? "width:15%;right: -5px;" : "" ?>" class="position-absolute eye-icon-wrap">
