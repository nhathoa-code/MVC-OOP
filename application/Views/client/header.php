...
<head>
    ...
    <link rel="stylesheet" href="<?php echo url("client_assets/css/bootstrap.min.css"); ?>">
    ...
    <?php if(strpos(current_route(),"product/detail") !== false): ?>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo url("client_assets/css/photoswipe.css") ?>"/>
    <?php endif; ?>
    <?php if(strpos(current_route(),"") !== false): ?>
        <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"/>
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
    <?php endif; ?>
    <?php if(strpos(current_route(),"collection") !== false): ?>
        <style>
            .price-check label::before {
                background-image: url(<?php echo url("client_assets/images/multi-select.svg") ?>);
            }
    ...
    <nav id="header" class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="<?php echo url("/") ?>">
                <img style="width: 60px;" src="<?php echo url("client_assets/images/logo-black.png")  ?>" alt="">
            </a>
                    ...
                    <div id="cart-header" class="position-relative">
                        <a href="<?php echo url("cart"); ?>" aria-label="0">
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.47803 9.03125V8.25492C8.47803 6.45418 9.95882 4.68544 11.7996 4.51737C13.9921 4.30929 15.8411 5.99799 15.8411 8.10286V9.20732" stroke="#000" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M9.70483 20.5H14.6135C17.9024 20.5 18.4914 19.2115 18.6632 17.6428L19.2768 12.8408C19.4977 10.888 18.925 9.29535 15.4316 9.29535H8.88671C5.39335 9.29535 4.82067 10.888 5.04156 12.8408L5.65515 17.6428C5.82696 19.2115 6.416 20.5 9.70483 20.5Z" stroke="#000" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M15.0188 12.4967H15.0262" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M9.29128 12.4967H9.29863" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg><span class="number">
                                <?php
                                    use NhatHoa\App\Services\CartService;
                                    $cartService = new CartService();
                                    echo $cartService->countTotalItems();
                                ?>
                            </span>
                        </a>
                        <div id="mini-cart" class="position-absolute">
                            <div class="d-flex flex-column h-100 p-2">
                                <div id="mini-cart-items" class="flex-grow-1">
                                    <?php if($cartService->countTotalItems() !== 0): ?>
                                        <?php foreach(array_reverse($cartService->getItems()) as $key => $item): ?>
                                            <div class="row mini-cart-item mx-0 pb-3 cart-item-<?php echo $key ?>" style="font-size: 14px;">
                                                ...
                                                <div class="col-8 ps-0">
                                                    ...
                                                    <div class="quantity">Số lượng: <span class="cart-qty-<?php echo $key; ?>" style="font-weight:600"><?php echo $item['quantity'] ?></span></div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>    
                                    <?php else: ?>
                                ...
                                <div id="mini-cart-subtotal" class="mt-2">
                                    <div style="font-weight:600" class="d-flex">
                                        ...
                                        <div class="mini-number"><?php echo number_format($cartService->countSubtotal(),0,"",".") ?> VND</div>
                                    </div>
