...
<?php endif; ?>  
<div class="heading">Sửa tỉnh/thành</div>
<form id="update-cat-form" method="POST" action="<?php echo url("admin/location/province/update/{$province->id}") ?>">
    <div class="row mb-5">
        <div class="col-2">
            <label for="">Tên tỉnh/thành</label>
        </div>
        <div class="col-5">
            <input type="text" name="name" value="<?php echo $old["name"] ?? $province->name ?>" class="form-control">
    ...
    <div class="row">
        <button class="btn btn-primary mr-2">Cập nhật tỉnh/thành</button>
    </div>
