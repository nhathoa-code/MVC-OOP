...
<?php endif; ?>  
<div class="heading">Hóa đơn bán hàng</div>
<div class="row">
    <div class="row col-12 pr-0">
        <div class="col-7">
            <form method="GET" class="mb-3">
                <input type="text" name="keyword" value="<?php echo get_query("keyword") ?? "" ?>" class="form-control" placeholder="Tìm hóa đơn theo mã hoặc số điện thoại/tên khách hàng">
            </form>  
        </div>
            ...
            <tbody>
                <?php foreach($invoices as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url("admin/customer/{$item->customer_id}/purchase/history") ?>"><?php echo $item->customer; ?></a>
                        </td>
                        <td>
