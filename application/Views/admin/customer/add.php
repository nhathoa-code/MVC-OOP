...
<?php endif; ?>  
<div class="heading">Thêm Khách hàng</div>
<form id="update-cat-form" method="POST" action="<?php echo url("admin/customer/add") ?>">
    <div class="row mb-5">
        <div class="col-2">
    ...
    <div class="row">
        <button class="btn btn-primary mr-2">Thêm khách hàng</button>
    </div>
