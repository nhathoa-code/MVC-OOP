...
<div class="row">
    <div class="col-4">
        <form method="POST" action="<?php echo url("admin/role/add") ?>">
            <div class="mb-3">
                    ...
                    <div class="d-flex" style="gap:50px">
                        ...
                        <?php foreach($item->permissions as $permis): ?>
                            <div class="mb-3 form-check">
                                <input name="permissions[]" value="<?php echo $permis->id ?>" type="checkbox" class="form-check-input" id="permission-<?php echo $permis->id ?>">
            ...
            <div class="d-flex align-items-center">
                <button class="btn btn-primary mr-2">Thêm vai trò</button>
            </div>
